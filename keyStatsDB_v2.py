...
from KeyStatsScrape_v2 import keyStats
...
def keyStatsFunc(tkrs):
	...
	cursor.execute('''CREATE TABLE IF NOT EXISTS keyStats(tickerDate VARCHAR(45),
					avgDivYield REAL,avgVol10d VARCHAR(15),avgVol30d VARCHAR(15),beta REAL,bookValPS REAL,
					cash VARCHAR(45),cashPS REAL,companyName VARCHAR(45),currRatio REAL,d52week REAL,
					...
					shrsShrt REAL,shrsShrtNew REAL,sp52week REAL,ticker VARCHAR(45),totDebt REAL,
	...
	for t in tkrs:
		...
		try:
			cursor.execute('''INSERT IGNORE INTO keyStats(tickerDate,avgDivYield,avgVol10d,
							...
							totDebtEquity,trailPE) VALUES(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,
							%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)''', (tickerDate,ks.avgDivYield,ks.avgVol10d,
